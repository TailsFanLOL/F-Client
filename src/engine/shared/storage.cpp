...
public:
	...
	void FindDataDir()
	{
		...
		{
			const char *aDirs[] = {
				"/usr/share/F-Client/data",
				"/usr/share/games/F-Client/data",
				"/usr/local/share/F-Client/data",
				"/usr/local/share/games/F-Client/data",
				"/usr/pkg/share/F-Client/data",
				"/usr/pkg/share/games/F-Client/data",
				"/opt/F-Client/data"
			};
